  ...
  if ("serviceWorker" in navigator) {
    ...
    window.addEventListener('load', async () => {
      ...
      //            log that it was successful.
        if (registration) { console.log("Service worker has been successfully registered"); }
...
async function getRecipes() {
  ...
  let recipes_local_storage = localStorage.getItem('recipes');
  if(recipes_local_storage) { return JSON.parse(recipes_local_storage); }
  /**************************/
  ...
  /**************************/
    ...
    //            declared above
    for (const recicpe_url of RECIPE_URLS) {
      ...
      try {
        ...
        const response = await fetch(recicpe_url);
        ...
        //            resolve() method.
        if (recipe_arr.length == RECIPE_URLS.length) {
          saveRecipesToStorage(recipe_arr);
          resolve(recipe_arr);
        }
      }
      catch(error) {
